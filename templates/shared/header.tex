...
\input{templates/shared/Math.tex}  % 基於workspace根目錄的相對路徑，如果編譯的執行位置是在根目錄應該不會有問題
...
\declaretheorem[style=thmblue2box, name=Check, numbered=no]{check*}
\declaretheorem[style=thmblue2box, name=Assum, numbered=no]{assume}
...
\declaretheorem[style=thmyellowline, numbered=no, name=Remark]{remark}
\declaretheorem[style=thmyellowline, numbered=no, name=Note]{note}
\declaretheorem[style=thmyellowline, numbered=no, name=Picture]{Picture}
\declaretheorem[style=thmpinkbox, numberwithin=section, name=Exercise]{exercise}
...
\declaretheorem[style=notgraybox, numbered=no, name=Question]{question}
\declaretheorem[style=thmgreen3box, name=Observation, numbered=no]{observation}
